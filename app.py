...
try:
    model = load_model(r'D:\Portfolio\my-gold\gold-price-forecast-api\lstm_model_97%.keras')
    f_scaler = joblib.load(r'D:\Portfolio\my-gold\gold-price-forecast-api\feature_scaler.pkl')
    t_scaler = joblib.load(r'D:\Portfolio\my-gold\gold-price-forecast-api\target_scaler.pkl')
